...
var __$v = 'http://www.sac.net.cn/phpstat/phpstat';
var __$clienturlstr = '';
function __$a() {
    return true;
};
...
var __$x = 'http://www.sac.net.cn/tzzyd/';
var __$y = '';
var __$z = '';
...
if (__$j) {
    __$u.write(__$0c);
    __$u.write("<iframe src='" + __$0c + "' width=100% height=500></iframe>");
} else {
...
function __$bcc(ev) {
    ...
    var cko = 'www.sac.net.cn';
    var ckd = '.doc|.csv|.xls|.pdf|.rar|.zip|.wmv|.mp3';
    if ((el.tagName == 'A' || el.tagName == 'IMG') && cko) {
        ...
        var ckoa = new Array(); ckoa[0]='www.sac.net.cn';;
        var ckda = new Array(); ckda[0]='.doc';ckda[1]='.csv';ckda[2]='.xls';ckda[3]='.pdf';ckda[4]='.rar';ckda[5]='.zip';ckda[6]='.wmv';ckda[7]='.mp3';
        var ckook = true;
